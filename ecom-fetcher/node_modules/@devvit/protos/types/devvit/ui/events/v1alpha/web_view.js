...
import { UpdateRequestContextEvent } from "../../effect_types/v1alpha/update_request_context.js";
...
import { WebViewScreenshotRequestEvent } from "../../effects/web_view/v1alpha/screenshot.js";
/**
 * Blocks only.
 *
 * @deprecated
...
export const WebViewInternalEventMessage = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.screenshot !== undefined) {
            WebViewScreenshotRequestEvent.encode(message.screenshot, writer.uint32(82).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 10:
                    ...
                    message.screenshot = WebViewScreenshotRequestEvent.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            updateRequestContext: isSet(object.updateRequestContext)
                ? UpdateRequestContextEvent.fromJSON(object.updateRequestContext)
                : undefined,
            screenshot: isSet(object.screenshot) ? WebViewScreenshotRequestEvent.fromJSON(object.screenshot) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.screenshot !== undefined) {
            obj.screenshot = WebViewScreenshotRequestEvent.toJSON(message.screenshot);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.updateRequestContext = (object.updateRequestContext !== undefined && object.updateRequestContext !== null)
            ? UpdateRequestContextEvent.fromPartial(object.updateRequestContext)
            : undefined;
        message.screenshot = (object.screenshot !== undefined && object.screenshot !== null)
            ? WebViewScreenshotRequestEvent.fromPartial(object.screenshot)
            : undefined;
        return message;
    },
};
