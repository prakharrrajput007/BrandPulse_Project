...
import { computeClusterFromJSON, computeClusterToJSON } from "./compute_cluster.js";
...
export const AppInfo = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.defaultPlaytestSubredditId !== "") {
            writer.uint32(170).string(message.defaultPlaytestSubredditId);
        }
        if (message.promoStatus !== 0) {
            writer.uint32(176).int32(message.promoStatus);
        }
        ...
        if (message.defaultComputeCluster !== 0) {
            writer.uint32(200).int32(message.defaultComputeCluster);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 21:
                    ...
                    message.defaultPlaytestSubredditId = reader.string();
                    continue;
                case 22:
                    if (tag !== 176) {
                        break;
    ...
    fromJSON(object) {
        return {
            ...
            minSubredditSizeRestrictionEnabled: isSet(object.minSubredditSizeRestrictionEnabled)
                ...
                : false,
            defaultPlaytestSubredditId: isSet(object.defaultPlaytestSubredditId)
                ? globalThis.String(object.defaultPlaytestSubredditId)
                : "",
    ...
    toJSON(message) {
        ...
        if (message.defaultPlaytestSubredditId !== "") {
            obj.defaultPlaytestSubredditId = message.defaultPlaytestSubredditId;
        }
        if (message.promoStatus !== 0) {
    ...
    fromPartial(object) {
        ...
        message.defaultComputeCluster = object.defaultComputeCluster ?? 0;
        return message;
    },
};
