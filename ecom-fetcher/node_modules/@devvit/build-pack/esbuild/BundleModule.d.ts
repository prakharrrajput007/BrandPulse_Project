 ...
 */
export declare function dangerouslyGetBundleActor(code: string): Promise<ConcreteActorType>;
declare class ConcreteActor extends Actor {
    constructor(cfg: Config);
}
/** For typing only, a fake instantiable Actor subclass. */
export type ConcreteActorType = typeof ConcreteActor;
export {};
//# sourceMappingURL=BundleModule.d.ts.map