...
var _AssetUploader_instances, _AssetUploader_cmd, _AssetUploader_verbose, _AssetUploader_appClient, _AssetUploader_appSlug, _AssetUploader_skipWebViewScriptInjection, _AssetUploader_processRegularAssets, _AssetUploader_processWebViewAssets, _AssetUploader_uploadNewAssets, _AssetUploader_mapAssets;
...
// TODO: Delete this, or ExperimentalAssetUploader, once we've tested that fully and are either
//  happy with it or give up on it.
export class AssetUploader {
    constructor(cmd, appSlug, { verbose }) {
        ...
        _AssetUploader_skipWebViewScriptInjection.set(this, !!process.env.DEVVIT_SKIP_WEB_VIEW_SCRIPT_INJECTION);
        ...
        if (__classPrivateFieldGet(this, _AssetUploader_skipWebViewScriptInjection, "f"))
            console.info('Skipping web view script injection.');
    }
    /**
    ...
    async syncAssets() {
        ...
        const [regularAssets, webViewAssets] = await Promise.all([
            __classPrivateFieldGet(this, _AssetUploader_cmd, "f").project.mediaDir
                ? queryAssets(path.join(__classPrivateFieldGet(this, _AssetUploader_cmd, "f").project.root, __classPrivateFieldGet(this, _AssetUploader_cmd, "f").project.mediaDir), ALLOWED_ASSET_EXTENSIONS, 'Media', clientVersion, __classPrivateFieldGet(this, _AssetUploader_skipWebViewScriptInjection, "f"))
                : [],
            __classPrivateFieldGet(this, _AssetUploader_cmd, "f").project.clientDir
                ? queryAssets(path.join(__classPrivateFieldGet(this, _AssetUploader_cmd, "f").project.root, __classPrivateFieldGet(this, _AssetUploader_cmd, "f").project.clientDir), [], 'Client', clientVersion, __classPrivateFieldGet(this, _AssetUploader_skipWebViewScriptInjection, "f"))
                : [],
        ]);
...
_AssetUploader_cmd = new WeakMap(), _AssetUploader_verbose = new WeakMap(), _AssetUploader_appClient = new WeakMap(), _AssetUploader_appSlug = new WeakMap(), _AssetUploader_skipWebViewScriptInjection = new WeakMap(), _AssetUploader_instances = new WeakSet(), _AssetUploader_processRegularAssets = async function _AssetUploader_processRegularAssets(assets) {
    ...
    try {
        ...
        __classPrivateFieldGet(this, _AssetUploader_cmd, "f").log(msg);
        if (webViewAsset) {
            ux.action.stop(msg);
