...
import { doEnvFileReplacement, isAppConfig, parseClassicConfig, Project, validateConfig, } from './project.js';
const noPermissions = {
...
describe('doEnvFileReplacement()', () => {
    test('replaces env variables', () => {
        expect(doEnvFileReplacement('VAR_NAME=something', 'VAR_NAME', 'something-else')).toBe('VAR_NAME=something-else');
    });
    test(`do nothing if the var isn't in the file`, () => {
        expect(doEnvFileReplacement('VAR_NAME=something', 'MISSING_VAR', 'something-else')).toBe('VAR_NAME=something');
    });
    test('handle multi-line fine', () => {
        expect(doEnvFileReplacement('VAR_1=a\nVAR_NAME=something\nVAR_3=c', 'VAR_NAME', 'something-else')).toBe('VAR_1=a\nVAR_NAME=something-else\nVAR_3=c');
    });
});
