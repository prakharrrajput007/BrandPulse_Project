...
async function addDirectoryToZip(dir, zipFolder, ignoredPaths, relativePath = '') {
    ...
    for (const entry of entries) {
        ...
        if (entry.isDirectory()) {
            ...
            if (newZipFolder) {
                ...
                dirCallbacks.push(() => addDirectoryToZip(fullPath, newZipFolder, ignoredPaths, relativeEntryPath));
            }
        }
