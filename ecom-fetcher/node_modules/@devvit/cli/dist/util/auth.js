...
const getRedirectURI = (port) => `http://localhost:${port}/authorize_callback`;
...
export async function getAccessToken() {
    try {
        ...
        return (await getOAuthSvc().refreshStoredToken(tokenInfo.token.refreshToken, Boolean(tokenInfo.copyPaste))).token;
    }
    catch {
        // probably logged out
        return;
...
export async function getAccessTokenAndLoginIfNeeded(method) {
    if (method === 'CopyPaste') {
