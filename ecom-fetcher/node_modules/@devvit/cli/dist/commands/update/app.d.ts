...
export default class UpdateApp extends DevvitCommand {
    ...
    doUpdatesSince(oldestVersion: semver.SemVer): Promise<void>;
    run(): Promise<void>;
}
 ...
 */
export declare function matchDevvitPackageVersions(projectRoot: string, devvitVersion: SemVer, forceUpdate?: boolean): Promise<VersionUpgradeResult>;
