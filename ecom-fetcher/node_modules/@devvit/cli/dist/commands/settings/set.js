...
class SetAppSettings extends DevvitCommand {
    constructor() {
        super(...arguments);
        _SetAppSettings_instances.add(this);
        _SetAppSettings_appSettingsService.set(this, createAppSettingsClient());
        _SetAppSettings_appService.set(this, createAppClient());
    }
    async run() {
        ...
        try {
            const appInfo = await getAppBySlug(__classPrivateFieldGet(this, _SetAppSettings_appService, "f"), {
            ...
            if (!appId) {
                ux.action.stop("Error: Your app doesn't exist yet - you'll need to run 'devvit upload' before you can set settings.");
                return;
            }
