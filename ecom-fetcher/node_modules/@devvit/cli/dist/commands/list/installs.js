...
class ListInstalls extends DevvitCommand {
    constructor() {
        ...
        _ListInstalls_installationsClient.set(this, createInstallationsClient());
    }
    init(_mode) {
...
_ListInstalls_installationsClient = new WeakMap(), _ListInstalls_instances = new WeakSet(), _ListInstalls_fetchInstalls = async function _ListInstalls_fetchInstalls(subreddit) {
    ...
    if (subreddit != null) {
        ...
        return await __classPrivateFieldGet(this, _ListInstalls_installationsClient, "f").GetAllWithInstallLocation({
            location: subreddit,
    ...
    return await __classPrivateFieldGet(this, _ListInstalls_installationsClient, "f").GetAllWithInstaller({
        installedBy: myId,
    });
}, _ListInstalls_formatAndLogInstallations = async function _ListInstalls_formatAndLogInstallations(installations, searchType) {
    const fullInstallationsInfo = await Promise.all(installations.map((i) => __classPrivateFieldGet(this, _ListInstalls_installationsClient, "f").GetByUUID({ id: i.id })));
