...
const GET_REDDITOR_INFO_BY_NAME_QUERY_HASH = '19b0be6bef17faf58939802d3858fec2622ba5ec28d6b8a2982998749ceca30b';
const GET_SUBREDDIT_INFO_BY_ID_QUERY_HASH = '109b67500ceb4e883d6a0e15e1699948e957bf85dc630651f1e10463b6ed5db6';
...
export async function isCurrentUserEmployee(token) {
    // Hack: GQL is failing below on snoodev.
    if (MY_PORTAL_ENABLED)
        return false;
    const identity = await gqlQuery({
