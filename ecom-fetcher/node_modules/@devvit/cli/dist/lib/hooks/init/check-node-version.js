...
const hook = async function () {
    ...
    if (!requiredVersion.startsWith('>=')) {
        this.error("Required version doesn't start with '>=', please check the package.json file and/or update the check-node-version hook.");
    }
    ...
    for (let i = 0; i < 3; i++) {
        if (curVersion[i] < reqVersion[i]) {
            this.error(`Node.js ${requiredVersion} is required, but you are using Node.js ${currentVersion}. Check` +
